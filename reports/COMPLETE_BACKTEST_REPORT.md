...
本报告展示了基于机器学习的ETF轮动策略在2024年11月至2026年1月期间的回测表现。策略通过HistGradientBoosting模型预测ETF未来收益，并使用EMA动态仓位管理系统进行交易。
...
**关键观察**：
- 策略在2024年11月开始即展现出显著的超额收益能力
- 在2024年12月至2025年1月期间经历了较大回撤，但随后快速恢复
- 2025年下半年至2026年初持续保持稳定的超额收益
...
**风险分析**：
- 策略最大回撤-24.92%出现在2024年12月，高于基准的-13.88%
- 回撤主要集中在市场剧烈波动期间
...
**季节性分析**：
- 2024年11-12月：剧烈波动期，单月收益率波动较大
- 2025年全年：整体表现稳定，多数月份录得正收益
- 2026年1月：继续保持正收益
...
**胜率分析**：
- 策略绝对胜率55.4%，略高于50%中位数
- 相对基准胜率50.5%，说明策略在略微超过一半的交易日跑赢基准
- 亏损天数占比相对较低，风险控制有效
...
- 滚动波动率在2024年底达到峰值后逐步回落
- 2025年下半年策略进入稳定期，收益和波动都趋于平稳
...
### 2. **机器学习驱动**
- 使用HistGradientBoosting算法，对非线性关系有强捕捉能力
- 结合技术指标和情绪指标，多维度信息融合
...
10. ✅ **策略摘要JSON**: `reports/ml_auto_tune_summary.json`
