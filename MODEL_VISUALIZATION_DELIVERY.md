...
✅ **visualize_model_internals.py** (520 行代码)
...
| 4️⃣ | ROC 和 PR 曲线 | 264KB | 综合性能指标 |
| 5️⃣ | 特征相关性矩阵 | 162KB | 多重共线性检查 |
| 6️⃣ | 预测 vs 实际收益 | 752KB | 预测可靠性验证 |
