...
print("🏃 正在启动《选题2》量化回测引擎...")
print("💡 增强策略方案：20日均线(SMA20) 趋势跟踪策略 vs 纯基准买入持有(B&H)")
...
for code, name in selected_assets.items():
    ...
    # 信号生成：1为持仓，0为空仓。将信号平移一天防范未来函数 (Look-ahead bias)
    ...
    summary_results.append({
        '资产': name, '代码': code, '组合模式': 'SMA20趋势增强',
...
print("\n==========================================================================")
print("📈 回测绩效对比表 (SMA20均线增强 vs 纯被动持有)")
print("==========================================================================")
