...
# ==================================================================================
TRAIN_LOOKBACK_DAYS = 730   # 1. 机器学习滚动训练的历史回溯窗口天数 (2年)
PROB_RANK_WINDOW = 20       # 2. AI胜率概率池的滚动分位数排名回溯窗口 (月频自适应)
TECH_MA_WINDOW = 20         # 3. 本地技术面SMA均线的滤波滤波窗口
SENT_MA_WINDOW = 20         # 4. 全局搜索引擎情绪因子Z-Score的计算滚动窗口
...
print("\n" + "="*98)
print("👑 归一化升级看板：《9只中证宽基复合动态规则策略》分阶段自适应检验 (稳健性全面净化)")
print("==================================================================================================")
