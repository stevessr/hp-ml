...
### 4. 自动化工作流
启动了 `model-accuracy-optimization` 工作流，包含 5 个阶段：
...
|------|------|-----------|---------|
| 基线 | Ridge 回归 | 71.76% | - |
| 阶段 1 | LightGBM 基础 | 74-78% | +3-6% |
| 阶段 2 | + 特征工程 | 77-82% | +5-10% |
| 阶段 3 | + 超参数调优 | 79-85% | +7-13% |
| 阶段 4 | + 模型集成 | 81-87% | +9-15% |
